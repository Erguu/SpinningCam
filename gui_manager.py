...
class GuiManager:
    ...
    def build_interface(self, app):
        ...
        s_bzsh = self.add_slider(lambda v: app.on_param_change("blank_z_shift", v, "all"), [-100, 100], app.params.get("blank_z_shift", 0.0), "Sac Z Ince Ayar", vy, C_VIS, "vis")
        self.add_tuner_buttons(lambda v: app.adjust_val_wrapper("blank_z_shift", -0.5, s_bzsh, "all"), lambda v: app.adjust_val_wrapper("blank_z_shift", 0.5, s_bzsh, "all"), lambda v: app.ask_val_wrapper("blank_z_shift", "Sac Z Ince Ayar", s_bzsh, "all"), vy, "vis"); vy -= GAP
